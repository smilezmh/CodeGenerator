...
<#else>
public class ${table.serviceImplName}<T,U> extends ${superServiceImplClass}<${table.mapperName}, ${entity}> implements ${table.serviceName} {
    ...
    */
    @Override
    public ${entity} saveOrUpdateWithEntityReturnBack(${entity} entity) {
