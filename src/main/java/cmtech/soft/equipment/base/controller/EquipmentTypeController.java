...
import cmtech.soft.equipment.base.service.IEquipmentTypeService;
...
@Api(tags = "设备类型基本接口")
@RestController
@RequestMapping("/base/equipment-type")
public class EquipmentTypeController {
    ...
    public HttpResult saveOrUpdataBath(@RequestBody(required = true) List<EquipmentType> entities)  {
    ...
    public HttpResult insertBatchWithCodeRepeatCheck(@RequestBody(required = true) List<EquipmentType> entities) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getPageByContition(@RequestBody(required = false) QueryModelEquipmentType condition) {
        HttpResult result = new HttpResult();
        IPage<EquipmentType> page = service.getPageByContition(condition);
    ...
    public HttpResult getListByQueryModel(@RequestBody(required = false) QueryModelEquipmentType condition) {
        HttpResult result = new HttpResult();
        List<EquipmentType> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getFirstOneByQueryModel(@RequestBody(required = false) QueryModelEquipmentType condition) {
    HttpResult result = new HttpResult();
        List<EquipmentType> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getRandomOneByQueryModel(@RequestBody(required = false) QueryModelEquipmentType condition) {
        HttpResult result = new HttpResult();
        EquipmentType entity=service.getRandomOneByQueryModel(condition);
    ...
    public HttpResult getEntityByCode(@RequestParam(defaultValue = "") String code) {
        ...
        EquipmentType entity = service.getOne(queryWrapper);
    ...
    public HttpResult saveOrUpdateWithIdReturnBack(@RequestBody(required = true) EquipmentType entity) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult isExistsByQueryModel(@RequestBody(required = true) QueryModelEquipmentType condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult updateByQueryModel(@RequestBody(required = true) QueryModelEquipmentType condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getTablesPageByContition(@RequestBody(required = false) QueryModelEquipmentType condition) {
        HttpResult result = new HttpResult();
        IPage<EquipmentType> page = service.getTablesPageByContition(condition);
    ...
    public HttpResult getTablesByContition(@RequestBody(required = false) QueryModelEquipmentType condition) {
        HttpResult result = new HttpResult();
        List<EquipmentType> list = service.getTablesByContition(condition);
