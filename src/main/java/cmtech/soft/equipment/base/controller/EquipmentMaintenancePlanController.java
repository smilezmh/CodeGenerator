...
@Api(tags = " 设备保养计划基本接口")
@RestController
@RequestMapping("/base/equipment-maintenance-plan")
public class EquipmentMaintenancePlanController {
    @Autowired
    private IEquipmentMaintenancePlanService service;

    @ApiOperation("批量修改或插入")
    @PostMapping(value = "saveOrUpdataBath")
    @InterceptAction("批量修改或插入")
    public HttpResult saveOrUpdataBath(@RequestBody(required = true) List<EquipmentMaintenancePlan> entities)  {
    ...
    public HttpResult insertBatchWithCodeRepeatCheck(@RequestBody(required = true) List<EquipmentMaintenancePlan> entities) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getPageByContition(@RequestBody(required = false) QueryModelEquipmentMaintenancePlan condition) {
        HttpResult result = new HttpResult();
        IPage<EquipmentMaintenancePlan> page = service.getPageByContition(condition);
    ...
    public HttpResult getListByQueryModel(@RequestBody(required = false) QueryModelEquipmentMaintenancePlan condition) {
        HttpResult result = new HttpResult();
        List<EquipmentMaintenancePlan> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getFirstOneByQueryModel(@RequestBody(required = false) QueryModelEquipmentMaintenancePlan condition) {
    HttpResult result = new HttpResult();
        List<EquipmentMaintenancePlan> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getRandomOneByQueryModel(@RequestBody(required = false) QueryModelEquipmentMaintenancePlan condition) {
        HttpResult result = new HttpResult();
        EquipmentMaintenancePlan entity=service.getRandomOneByQueryModel(condition);
    ...
    public HttpResult getEntityByCode(@RequestParam(defaultValue = "") String code) {
        ...
        EquipmentMaintenancePlan entity = service.getOne(queryWrapper);
    ...
    public HttpResult saveOrUpdateWithIdReturnBack(@RequestBody(required = true) EquipmentMaintenancePlan entity) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult isExistsByQueryModel(@RequestBody(required = true) QueryModelEquipmentMaintenancePlan condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult updateByQueryModel(@RequestBody(required = true) QueryModelEquipmentMaintenancePlan condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getTablesPageByContition(@RequestBody(required = false) QueryModelEquipmentMaintenancePlan condition) {
        HttpResult result = new HttpResult();
        IPage<EquipmentMaintenancePlan> page = service.getTablesPageByContition(condition);
    ...
    public HttpResult getTablesByContition(@RequestBody(required = false) QueryModelEquipmentMaintenancePlan condition) {
        HttpResult result = new HttpResult();
        List<EquipmentMaintenancePlan> list = service.getTablesByContition(condition);
