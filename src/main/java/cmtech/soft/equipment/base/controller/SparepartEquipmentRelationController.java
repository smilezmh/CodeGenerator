 ...
 * @since 2020-01-14
 */
@Api(tags = "设备备件绑定关系 基本接口")
@RestController
@RequestMapping("/base/sparepart-equipment-relation")
public class SparepartEquipmentRelationController {
    @Autowired
    private ISparepartEquipmentRelationService service;

    @ApiOperation("批量修改或插入")
    @PostMapping(value = "saveOrUpdataBath")
    @InterceptAction("批量修改或插入")
    public HttpResult saveOrUpdataBath(@RequestBody(required = true) List<SparepartEquipmentRelation> entities)  {
    ...
    public HttpResult insertBatchWithCodeRepeatCheck(@RequestBody(required = true) List<SparepartEquipmentRelation> entities) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getPageByContition(@RequestBody(required = false) QueryModelSparepartEquipmentRelation condition) {
        HttpResult result = new HttpResult();
        IPage<SparepartEquipmentRelation> page = service.getPageByContition(condition);
    ...
    public HttpResult getListByQueryModel(@RequestBody(required = false) QueryModelSparepartEquipmentRelation condition) {
        HttpResult result = new HttpResult();
        List<SparepartEquipmentRelation> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getFirstOneByQueryModel(@RequestBody(required = false) QueryModelSparepartEquipmentRelation condition) {
    HttpResult result = new HttpResult();
        List<SparepartEquipmentRelation> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getRandomOneByQueryModel(@RequestBody(required = false) QueryModelSparepartEquipmentRelation condition) {
        HttpResult result = new HttpResult();
        SparepartEquipmentRelation entity=service.getRandomOneByQueryModel(condition);
    ...
    public HttpResult getEntityByCode(@RequestParam(defaultValue = "") String code) {
        ...
        SparepartEquipmentRelation entity = service.getOne(queryWrapper);
    ...
    public HttpResult saveOrUpdateWithIdReturnBack(@RequestBody(required = true) SparepartEquipmentRelation entity) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult isExistsByQueryModel(@RequestBody(required = true) QueryModelSparepartEquipmentRelation condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult updateByQueryModel(@RequestBody(required = true) QueryModelSparepartEquipmentRelation condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getTablesPageByContition(@RequestBody(required = false) QueryModelSparepartEquipmentRelation condition) {
        HttpResult result = new HttpResult();
        IPage<SparepartEquipmentRelation> page = service.getTablesPageByContition(condition);
    ...
    public HttpResult getTablesByContition(@RequestBody(required = false) QueryModelSparepartEquipmentRelation condition) {
        HttpResult result = new HttpResult();
        List<SparepartEquipmentRelation> list = service.getTablesByContition(condition);
