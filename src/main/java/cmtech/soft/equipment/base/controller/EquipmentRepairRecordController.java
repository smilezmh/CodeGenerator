 ...
 * @since 2020-01-10
 */
@Api(tags = "设备维修记录表 基本接口")
@RestController
@RequestMapping("/base/equipment-repair-record")
public class EquipmentRepairRecordController {
    ...
    public HttpResult saveOrUpdataBath(@RequestBody(required = true) List<EquipmentRepairRecord> entities)  {
        HttpResult result=new HttpResult();
    ...
    public HttpResult insertBatchWithCodeRepeatCheck(@RequestBody(required = true) List<EquipmentRepairRecord> entities) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getPageByContition(@RequestBody(required = false) QueryModelEquipmentRepairRecord condition) {
        HttpResult result = new HttpResult();
        IPage<EquipmentRepairRecord> page = service.getPageByContition(condition);
    ...
    public HttpResult getListByQueryModel(@RequestBody(required = false) QueryModelEquipmentRepairRecord condition) {
        HttpResult result = new HttpResult();
        List<EquipmentRepairRecord> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getFirstOneByQueryModel(@RequestBody(required = false) QueryModelEquipmentRepairRecord condition) {
    HttpResult result = new HttpResult();
        List<EquipmentRepairRecord> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getRandomOneByQueryModel(@RequestBody(required = false) QueryModelEquipmentRepairRecord condition) {
        HttpResult result = new HttpResult();
        EquipmentRepairRecord entity=service.getRandomOneByQueryModel(condition);
    ...
    public HttpResult getEntityByCode(@RequestParam(defaultValue = "") String code) {
        ...
        EquipmentRepairRecord entity = service.getOne(queryWrapper);
    ...
    public HttpResult saveOrUpdateWithIdReturnBack(@RequestBody(required = true) EquipmentRepairRecord entity) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult isExistsByQueryModel(@RequestBody(required = true) QueryModelEquipmentRepairRecord condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult updateByQueryModel(@RequestBody(required = true) QueryModelEquipmentRepairRecord condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getTablesPageByContition(@RequestBody(required = false) QueryModelEquipmentRepairRecord condition) {
        HttpResult result = new HttpResult();
        IPage<EquipmentRepairRecord> page = service.getTablesPageByContition(condition);
    ...
    public HttpResult getTablesByContition(@RequestBody(required = false) QueryModelEquipmentRepairRecord condition) {
        HttpResult result = new HttpResult();
        List<EquipmentRepairRecord> list = service.getTablesByContition(condition);
