 ...
 * @since 2020-01-14
 */
@Api(tags = "设备保养内容和设备保养类型、设备类型关系维护表 基本接口")
@RestController
...
public class EquipmentMaintenanceContentRelationController {
    ...
    public HttpResult insertBatchWithCodeRepeatCheck(@RequestBody(required = true) List<EquipmentMaintenanceContentRelation> entities) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getPageByContition(@RequestBody(required = false) QueryModelEquipmentMaintenanceContentRelation condition) {
        HttpResult result = new HttpResult();
        IPage<EquipmentMaintenanceContentRelation> page = service.getPageByContition(condition);
    ...
    public HttpResult getEntityByCode(@RequestParam(defaultValue = "") String code) {
        ...
        EquipmentMaintenanceContentRelation entity = service.getOne(queryWrapper);
    ...
    public HttpResult saveOrUpdateWithIdReturnBack(@RequestBody(required = true) EquipmentMaintenanceContentRelation entity) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult isExistsByQueryModel(@RequestBody(required = true) QueryModelEquipmentMaintenanceContentRelation condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult updateByQueryModel(@RequestBody(required = true) QueryModelEquipmentMaintenanceContentRelation condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getTablesPageByContition(@RequestBody(required = false) QueryModelEquipmentMaintenanceContentRelation condition) {
        HttpResult result = new HttpResult();
        IPage<EquipmentMaintenanceContentRelation> page = service.getTablesPageByContition(condition);
    ...
    public HttpResult getTablesByContition(@RequestBody(required = false) QueryModelEquipmentMaintenanceContentRelation condition) {
        HttpResult result = new HttpResult();
