...
public class EquipmentMaintenanceRecordController {
    ...
    public HttpResult saveOrUpdataBath(@RequestBody(required = true) List<EquipmentMaintenanceRecord> entities)  {
    ...
    public HttpResult insertBatchWithCodeRepeatCheck(@RequestBody(required = true) List<EquipmentMaintenanceRecord> entities) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getPageByContition(@RequestBody(required = false) QueryModelEquipmentMaintenanceRecord condition) {
        HttpResult result = new HttpResult();
        IPage<EquipmentMaintenanceRecord> page = service.getPageByContition(condition);
    ...
    public HttpResult getListByQueryModel(@RequestBody(required = false) QueryModelEquipmentMaintenanceRecord condition) {
        HttpResult result = new HttpResult();
        List<EquipmentMaintenanceRecord> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getFirstOneByQueryModel(@RequestBody(required = false) QueryModelEquipmentMaintenanceRecord condition) {
    HttpResult result = new HttpResult();
        List<EquipmentMaintenanceRecord> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getRandomOneByQueryModel(@RequestBody(required = false) QueryModelEquipmentMaintenanceRecord condition) {
        HttpResult result = new HttpResult();
        EquipmentMaintenanceRecord entity=service.getRandomOneByQueryModel(condition);
    ...
    public HttpResult getEntityByCode(@RequestParam(defaultValue = "") String code) {
        ...
        EquipmentMaintenanceRecord entity = service.getOne(queryWrapper);
    ...
    public HttpResult saveOrUpdateWithIdReturnBack(@RequestBody(required = true) EquipmentMaintenanceRecord entity) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult isExistsByQueryModel(@RequestBody(required = true) QueryModelEquipmentMaintenanceRecord condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult updateByQueryModel(@RequestBody(required = true) QueryModelEquipmentMaintenanceRecord condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getTablesPageByContition(@RequestBody(required = false) QueryModelEquipmentMaintenanceRecord condition) {
        HttpResult result = new HttpResult();
        IPage<EquipmentMaintenanceRecord> page = service.getTablesPageByContition(condition);
    ...
    public HttpResult getTablesByContition(@RequestBody(required = false) QueryModelEquipmentMaintenanceRecord condition) {
        HttpResult result = new HttpResult();
        List<EquipmentMaintenanceRecord> list = service.getTablesByContition(condition);
