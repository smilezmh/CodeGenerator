 ...
 * @since 2020-01-14
 */
@Api(tags = "设备保养内容 基本接口")
@RestController
@RequestMapping("/base/equipment-maintenance-content")
public class EquipmentMaintenanceContentController {
    @Autowired
    private IEquipmentMaintenanceContentService service;

    @ApiOperation("批量修改或插入")
    @PostMapping(value = "saveOrUpdataBath")
    @InterceptAction("批量修改或插入")
    public HttpResult saveOrUpdataBath(@RequestBody(required = true) List<EquipmentMaintenanceContent> entities)  {
    ...
    public HttpResult insertBatchWithCodeRepeatCheck(@RequestBody(required = true) List<EquipmentMaintenanceContent> entities) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getPageByContition(@RequestBody(required = false) QueryModelEquipmentMaintenanceContent condition) {
        HttpResult result = new HttpResult();
        IPage<EquipmentMaintenanceContent> page = service.getPageByContition(condition);
    ...
    public HttpResult getListByQueryModel(@RequestBody(required = false) QueryModelEquipmentMaintenanceContent condition) {
        HttpResult result = new HttpResult();
        List<EquipmentMaintenanceContent> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getFirstOneByQueryModel(@RequestBody(required = false) QueryModelEquipmentMaintenanceContent condition) {
    HttpResult result = new HttpResult();
        List<EquipmentMaintenanceContent> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getRandomOneByQueryModel(@RequestBody(required = false) QueryModelEquipmentMaintenanceContent condition) {
        HttpResult result = new HttpResult();
        EquipmentMaintenanceContent entity=service.getRandomOneByQueryModel(condition);
    ...
    public HttpResult getEntityByCode(@RequestParam(defaultValue = "") String code) {
        ...
        EquipmentMaintenanceContent entity = service.getOne(queryWrapper);
    ...
    public HttpResult saveOrUpdateWithIdReturnBack(@RequestBody(required = true) EquipmentMaintenanceContent entity) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult isExistsByQueryModel(@RequestBody(required = true) QueryModelEquipmentMaintenanceContent condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult updateByQueryModel(@RequestBody(required = true) QueryModelEquipmentMaintenanceContent condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getTablesPageByContition(@RequestBody(required = false) QueryModelEquipmentMaintenanceContent condition) {
        HttpResult result = new HttpResult();
        IPage<EquipmentMaintenanceContent> page = service.getTablesPageByContition(condition);
    ...
    public HttpResult getTablesByContition(@RequestBody(required = false) QueryModelEquipmentMaintenanceContent condition) {
        HttpResult result = new HttpResult();
        List<EquipmentMaintenanceContent> list = service.getTablesByContition(condition);
