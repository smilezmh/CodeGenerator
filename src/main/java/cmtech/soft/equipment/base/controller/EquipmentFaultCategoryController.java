 ...
 * @since 2020-01-10
 */
@Api(tags = "设备故障类型 基本接口")
@RestController
@RequestMapping("/base/equipment-fault-category")
public class EquipmentFaultCategoryController {
    @Autowired
    private IEquipmentFaultCategoryService service;

    @ApiOperation("批量修改或插入")
    @PostMapping(value = "saveOrUpdataBath")
    @InterceptAction("批量修改或插入")
    public HttpResult saveOrUpdataBath(@RequestBody(required = true) List<EquipmentFaultCategory> entities)  {
    ...
    public HttpResult insertBatchWithCodeRepeatCheck(@RequestBody(required = true) List<EquipmentFaultCategory> entities) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getPageByContition(@RequestBody(required = false) QueryModelEquipmentFaultCategory condition) {
        HttpResult result = new HttpResult();
        IPage<EquipmentFaultCategory> page = service.getPageByContition(condition);
    ...
    public HttpResult getListByQueryModel(@RequestBody(required = false) QueryModelEquipmentFaultCategory condition) {
        HttpResult result = new HttpResult();
        List<EquipmentFaultCategory> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getFirstOneByQueryModel(@RequestBody(required = false) QueryModelEquipmentFaultCategory condition) {
    HttpResult result = new HttpResult();
        List<EquipmentFaultCategory> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getRandomOneByQueryModel(@RequestBody(required = false) QueryModelEquipmentFaultCategory condition) {
        HttpResult result = new HttpResult();
        EquipmentFaultCategory entity=service.getRandomOneByQueryModel(condition);
    ...
    public HttpResult getEntityByCode(@RequestParam(defaultValue = "") String code) {
        ...
        EquipmentFaultCategory entity = service.getOne(queryWrapper);
    ...
    public HttpResult saveOrUpdateWithIdReturnBack(@RequestBody(required = true) EquipmentFaultCategory entity) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult isExistsByQueryModel(@RequestBody(required = true) QueryModelEquipmentFaultCategory condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult updateByQueryModel(@RequestBody(required = true) QueryModelEquipmentFaultCategory condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getTablesPageByContition(@RequestBody(required = false) QueryModelEquipmentFaultCategory condition) {
        HttpResult result = new HttpResult();
        IPage<EquipmentFaultCategory> page = service.getTablesPageByContition(condition);
    ...
    public HttpResult getTablesByContition(@RequestBody(required = false) QueryModelEquipmentFaultCategory condition) {
        HttpResult result = new HttpResult();
        List<EquipmentFaultCategory> list = service.getTablesByContition(condition);
