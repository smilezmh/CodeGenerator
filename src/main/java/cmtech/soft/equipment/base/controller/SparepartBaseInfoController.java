 ...
 * @since 2020-01-14
 */
@Api(tags = "备件基础信息表 基本接口")
@RestController
@RequestMapping("/base/sparepart-base-info")
public class SparepartBaseInfoController {
    @Autowired
    private ISparepartBaseInfoService service;

    @ApiOperation("批量修改或插入")
    @PostMapping(value = "saveOrUpdataBath")
    @InterceptAction("批量修改或插入")
    public HttpResult saveOrUpdataBath(@RequestBody(required = true) List<SparepartBaseInfo> entities)  {
    ...
    public HttpResult insertBatchWithCodeRepeatCheck(@RequestBody(required = true) List<SparepartBaseInfo> entities) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getPageByContition(@RequestBody(required = false) QueryModelSparepartBaseInfo condition) {
        HttpResult result = new HttpResult();
        IPage<SparepartBaseInfo> page = service.getPageByContition(condition);
    ...
    public HttpResult getListByQueryModel(@RequestBody(required = false) QueryModelSparepartBaseInfo condition) {
        HttpResult result = new HttpResult();
        List<SparepartBaseInfo> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getFirstOneByQueryModel(@RequestBody(required = false) QueryModelSparepartBaseInfo condition) {
    HttpResult result = new HttpResult();
        List<SparepartBaseInfo> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getRandomOneByQueryModel(@RequestBody(required = false) QueryModelSparepartBaseInfo condition) {
        HttpResult result = new HttpResult();
        SparepartBaseInfo entity=service.getRandomOneByQueryModel(condition);
    ...
    public HttpResult getEntityByCode(@RequestParam(defaultValue = "") String code) {
        ...
        SparepartBaseInfo entity = service.getOne(queryWrapper);
    ...
    public HttpResult saveOrUpdateWithIdReturnBack(@RequestBody(required = true) SparepartBaseInfo entity) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult isExistsByQueryModel(@RequestBody(required = true) QueryModelSparepartBaseInfo condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult updateByQueryModel(@RequestBody(required = true) QueryModelSparepartBaseInfo condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getTablesPageByContition(@RequestBody(required = false) QueryModelSparepartBaseInfo condition) {
        HttpResult result = new HttpResult();
        IPage<SparepartBaseInfo> page = service.getTablesPageByContition(condition);
    ...
    public HttpResult getTablesByContition(@RequestBody(required = false) QueryModelSparepartBaseInfo condition) {
        HttpResult result = new HttpResult();
        List<SparepartBaseInfo> list = service.getTablesByContition(condition);
