...
@Api(tags = "备件类型表 基本接口")
@RestController
@RequestMapping("/base/sparepart-type")
public class SparepartTypeController {
    @Autowired
    private ISparepartTypeService service;

    @ApiOperation("批量修改或插入")
    @PostMapping(value = "saveOrUpdataBath")
    @InterceptAction("批量修改或插入")
    public HttpResult saveOrUpdataBath(@RequestBody(required = true) List<SparepartType> entities)  {
    ...
    public HttpResult insertBatchWithCodeRepeatCheck(@RequestBody(required = true) List<SparepartType> entities) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getPageByContition(@RequestBody(required = false) QueryModelSparepartType condition) {
        HttpResult result = new HttpResult();
        IPage<SparepartType> page = service.getPageByContition(condition);
    ...
    public HttpResult getListByQueryModel(@RequestBody(required = false) QueryModelSparepartType condition) {
        HttpResult result = new HttpResult();
        List<SparepartType> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getFirstOneByQueryModel(@RequestBody(required = false) QueryModelSparepartType condition) {
    HttpResult result = new HttpResult();
        List<SparepartType> list=service.getListByQueryModel(condition);
    ...
    public HttpResult getRandomOneByQueryModel(@RequestBody(required = false) QueryModelSparepartType condition) {
        HttpResult result = new HttpResult();
        SparepartType entity=service.getRandomOneByQueryModel(condition);
    ...
    public HttpResult getEntityByCode(@RequestParam(defaultValue = "") String code) {
        ...
        SparepartType entity = service.getOne(queryWrapper);
    ...
    public HttpResult saveOrUpdateWithIdReturnBack(@RequestBody(required = true) SparepartType entity) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult isExistsByQueryModel(@RequestBody(required = true) QueryModelSparepartType condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult updateByQueryModel(@RequestBody(required = true) QueryModelSparepartType condition) {
        HttpResult result = new HttpResult();
    ...
    public HttpResult getTablesPageByContition(@RequestBody(required = false) QueryModelSparepartType condition) {
        HttpResult result = new HttpResult();
        IPage<SparepartType> page = service.getTablesPageByContition(condition);
    ...
    public HttpResult getTablesByContition(@RequestBody(required = false) QueryModelSparepartType condition) {
        HttpResult result = new HttpResult();
        List<SparepartType> list = service.getTablesByContition(condition);
