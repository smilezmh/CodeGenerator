...
//public List<EquipmentMaintenancePlan> GetTwoTableInfo();
...
// public List<EquipmentMaintenancePlan> GetTwoTableInfoPage(IPage<EquipmentMaintenancePlan> cityPage, @Param(Constants.WRAPPER) Wrapper<EquipmentMaintenancePlan> wrapper);
    ...
    * @return list
    */
    public List<EquipmentMaintenancePlan> getTablesByContition(IPage<EquipmentMaintenancePlan> page, @Param("condition") QueryModelEquipmentMaintenancePlan condition);
    ...
    * @return list
    */
    public List<EquipmentMaintenancePlan> getTablesByContition(@Param("condition") QueryModelEquipmentMaintenancePlan condition);
}
