...
import cmtech.soft.equipment.base.mapper.EquipmentTypeMapper;
...
public class EquipmentTypeServiceImpl extends ServiceImpl<EquipmentTypeMapper, EquipmentType> implements IEquipmentTypeService {
    ...
    // 搜索条件
    private QueryWrapper<EquipmentType> wrapper;
    ...
    */
    @Override
    public List<EquipmentType> getListByQueryModel(QueryModelEquipmentType condition) {
        // 联表查询
        // return cityMapper.GetTwoTableInfo();

        wrapper = getListWrapper(condition);
        List<EquipmentType> list = list(wrapper);
        // 处理一些结果列
    ...
    */
    @Override
    public EquipmentType getRandomOneByQueryModel(QueryModelEquipmentType condition){
        QueryWrapper<EquipmentType> queryWrapper=new QueryWrapper<EquipmentType>();
        queryWrapper.eq("is_deleted",false);
        queryWrapper.lambda().eq(EquipmentType::getId,condition.getId());
    ...
    */
    @Override
    public IPage<EquipmentType> getPageByContition(QueryModelEquipmentType condition) {
        // 查询条件
        // QueryWrapper<EquipmentType> queryWrapper = new QueryWrapper<>();
        // 分页对象
        // IPage<EquipmentType> iPage = new Page<EquipmentType>();
    ...
    */
    @Override
    public int saveOrUpdateWithIdReturnBack(EquipmentType entity) {
        int id = 0;
    ...
    */
    public Integer insertBatchWithCodeRepeatCheck(List<EquipmentType> entities) {
    ...
    */
    @Override
    public boolean isExistsByQueryModel(QueryModelEquipmentType condition) {
        QueryWrapper<EquipmentType> queryWrapper = new QueryWrapper<>();
        queryWrapper.lambda().eq(EquipmentType::getId, condition.getId());
    ...
    */
    @Override
    public Integer updateByQueryModel(QueryModelEquipmentType condition) {
        EquipmentType entity = new EquipmentType();
        entity.setIsDeleted(true);

        UpdateWrapper<EquipmentType> updateWrapper = new UpdateWrapper<EquipmentType>();
        updateWrapper.lambda().eq(EquipmentType::getId, condition.getId());
    ...
    */
    @Override
    public IPage<EquipmentType> getTablesPageByContition(QueryModelEquipmentType condition){
        IPage<EquipmentType> page=new Page<EquipmentType>(condition.getCurrent(),condition.getSize());
    ...
    */
    @Override
    public List<EquipmentType> getTablesByContition(QueryModelEquipmentType condition){
    ...
    * @return 分页查询wrapper
    */
    private QueryWrapper<EquipmentType> getPageWrapper(QueryModelEquipmentType condition) {
    ...
    */
    private QueryWrapper<EquipmentType> getListWrapper(QueryModelEquipmentType condition) {
        wrapper = new QueryWrapper<EquipmentType>();
        // 查询需要的结果列
        // queryWrapper.select("id", "code", "name", "remark");
        // 查找没有删除的数据
    ...
    * @param list 实体list
    */
    private void dealWithViewName(List<EquipmentType> list) {
    ...
    * @return 是否重复
    */
    private boolean isCodesRepeat(List<EquipmentType> list) {
